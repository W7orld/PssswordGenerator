...
/**
 * Created by W7orld on 16/07/2020.
 */
enum PasswordStrength {

    WEAK(R.string.weak, Color.parseColor("#FF0939")),
    MEDIUM(R.string.medium, Color.parseColor("#FFC400")),
    STRONG(R.string.strong, Color.parseColor("#03FF1C")),
    VERY_STRONG(R.string.very_strong, Color.parseColor("#03FF1C"));
